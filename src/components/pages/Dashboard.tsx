...
import { MNEE_API } from "@/utils/api";
                            ...
                            <tr key={index}>
                                <td className="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                    <div className="flex items-center">
                                        ...
                                        <div className="ml-4">
                                            <div className="text-sm font-medium leading-5 text-gray-900">{data.name}</div>
                                ...
                                <td className="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                    ...
                                    <div className="text-sm leading-5 text-gray-500">{data.subtitle}</div>
                                </td>
                                <td className="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                    <span
...
const permissionData: TableRecord[] = [
    {
        name: "Jane Cooper",
        title: "Software Engineer",
        subtitle: "Optimization",
        email: "jcooper@someplace.com",
        status: "Active",
        role: "Owner"
    },
    {
