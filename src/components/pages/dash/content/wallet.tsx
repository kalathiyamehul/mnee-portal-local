        ...
        <div className="min-w-screen min-h-screen px-2 flex flex-col py-12 mb-4">
            ...
            {addresses && (
                <>
                    ...
                    {!config && <FaSpinner className="animate-spin mx-auto" />}
                    {config && <div className="mx-auto mb-4 flex flex-col items-center justify-center py-12">
                        <>
                            <h2 className="text-4xl"><span className="font-mono">{config ? toToken(mneeBalance, config.decimals) : '0'}</span> MNEE</h2>
